...
<p>Durante o desenvolvimento de um clone do Netflix feito durante o bootcamp da LOCALIZA - Digital Innovation One, criei o CodeFlix é um repositório centralizado de conteúdo em vídeo dos melhores canais de programação ranqueados pelo youtube por temas relevantes, como HTML, React, JavaScript.</p>
